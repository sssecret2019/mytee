...
#define CTX_MYTEE_OFFSET	(CTX_CVE_2018_3639_OFFSET + CTX_CVE_2018_3639_END)
#define CTX_MYTEE_X0		U(0x0)
#define CTX_MYTEE_X1		U(0x8)
#define CTX_MYTEE_X2		U(0x10)
#define CTX_MYTEE_X3		U(0x18)
#define CTX_MYTEE_X4		U(0x20)
#define CTX_MYTEE_X5		U(0x28)
#define CTX_MYTEE_X6		U(0x30)
#define CTX_MYTEE_X7		U(0x38)
#define CTX_MYTEE_X8		U(0x40)
#define CTX_MYTEE_X9		U(0x48)
#define CTX_MYTEE_X10		U(0x50)
#define CTX_MYTEE_X11		U(0x58)
#define CTX_MYTEE_X12		U(0x60)
#define CTX_MYTEE_X13		U(0x68)
#define CTX_MYTEE_X14		U(0x70)
#define CTX_MYTEE_X15		U(0x78)
#define CTX_MYTEE_X16		U(0x80)
#define CTX_MYTEE_X17		U(0x88)
#define CTX_MYTEE_X18		U(0x90)
#define CTX_MYTEE_X19		U(0x98)
#define CTX_MYTEE_X20		U(0xa0)
#define CTX_MYTEE_X21		U(0xa8)
#define CTX_MYTEE_X22		U(0xb0)
#define CTX_MYTEE_X23		U(0xb8)
#define CTX_MYTEE_X24		U(0xc0)
#define CTX_MYTEE_X25		U(0xc8)
#define CTX_MYTEE_X26		U(0xd0)
#define CTX_MYTEE_X27		U(0xd8)
#define CTX_MYTEE_X28		U(0xe0)
#define CTX_MYTEE_X29		U(0xe8)
#define CTX_MYTEE_LR		U(0xf0)
#define CTX_MYTEE_SP_EL0	U(0xf8)
#define CTX_MYTEE_END		U(0x100)

#define CTX_MYTEE_EL3STATE_OFFSET	(CTX_MYTEE_OFFSET + CTX_MYTEE_END)
#define CTX_MYTEE_SCR_EL3	U(0x0)
#define CTX_MYTEE_ESR_EL3	U(0x8)
#define CTX_MYTEE_RUNTIME_SP	U(0x10)
#define CTX_MYTEE_SPSR_EL3	U(0x18)
#define CTX_MYTEE_ELR_EL3	U(0x20)
#define CTX_MYTEE_UNUSED	U(0x28)
#define CTX_MYTEE_EL3STATE_END		U(0x30)

#define CTX_MYTEE_SYSREGS_OFFSET	(CTX_MYTEE_EL3STATE_OFFSET + CTX_MYTEE_EL3STATE_END)
#define CTX_MYTEE_SPSR_EL1		U(0x0)
#define CTX_MYTEE_ELR_EL1		U(0x8)
#define CTX_MYTEE_SCTLR_EL1		U(0x10)
#define CTX_MYTEE_ACTLR_EL1		U(0x18)
#define CTX_MYTEE_CPACR_EL1		U(0x20)
#define CTX_MYTEE_CSSELR_EL1		U(0x28)
#define CTX_MYTEE_SP_EL1		U(0x30)
#define CTX_MYTEE_ESR_EL1		U(0x38)
#define CTX_MYTEE_TTBR0_EL1		U(0x40)
#define CTX_MYTEE_TTBR1_EL1		U(0x48)
#define CTX_MYTEE_MAIR_EL1		U(0x50)
#define CTX_MYTEE_AMAIR_EL1		U(0x58)
#define CTX_MYTEE_TCR_EL1		U(0x60)
#define CTX_MYTEE_TPIDR_EL1		U(0x68)
#define CTX_MYTEE_TPIDR_EL0		U(0x70)
#define CTX_MYTEE_TPIDRRO_EL0		U(0x78)
#define CTX_MYTEE_PAR_EL1		U(0x80)
#define CTX_MYTEE_FAR_EL1		U(0x88)
#define CTX_MYTEE_AFSR0_EL1		U(0x90)
#define CTX_MYTEE_AFSR1_EL1		U(0x98)
#define CTX_MYTEE_CONTEXTIDR_EL1	U(0xa0)
#define CTX_MYTEE_VBAR_EL1		U(0xa8)
#define CTX_MYTEE_PMCR_EL0		U(0xb0)
/*
 * If the platform is AArch64-only, there is no need to save and restore these
 * AArch32 registers.
 */
#if CTX_INCLUDE_AARCH32_REGS
#define CTX_MYTEE_SPSR_ABT		U(0xc0)  /* Align to the next 16 byte boundary */
#define CTX_MYTEE_SPSR_UND		U(0xc8)
#define CTX_MYTEE_SPSR_IRQ		U(0xd0)
#define CTX_MYTEE_SPSR_FIQ		U(0xd8)
#define CTX_MYTEE_DACR32_EL2		U(0xe0)
#define CTX_MYTEE_IFSR32_EL2		U(0xe8)
#define CTX_MYTEE_TIMER_SYSREGS_OFF	U(0xf0) /* Align to the next 16 byte boundary */
#else
#define CTX_MYTEE_TIMER_SYSREGS_OFF	U(0xc0)  /* Align to the next 16 byte boundary */
#endif /* __CTX_INCLUDE_AARCH32_REGS__ */
 ...
 */
#if NS_TIMER_SWITCH
#define CTX_MYTEE_CNTP_CTL_EL0	(CTX_TIMER_SYSREGS_OFF + U(0x0))
#define CTX_MYTEE_CNTP_CVAL_EL0	(CTX_TIMER_SYSREGS_OFF + U(0x8))
#define CTX_MYTEE_CNTV_CTL_EL0	(CTX_TIMER_SYSREGS_OFF + U(0x10))
#define CTX_MYTEE_CNTV_CVAL_EL0	(CTX_TIMER_SYSREGS_OFF + U(0x18))
#define CTX_MYTEE_CNTKCTL_EL1		(CTX_TIMER_SYSREGS_OFF + U(0x20))
#define CTX_MYTEE_SYSREGS_END		(CTX_TIMER_SYSREGS_OFF + U(0x30)) /* Align to the next 16 byte boundary */
#else
#define CTX_MYTEE_SYSREGS_END		CTX_MYTEE_TIMER_SYSREGS_OFF
#endif /* __NS_TIMER_SWITCH__ */
...
#define CTX_MYTEE_ALL	(CTX_MYTEE_END >> DWORD_SHIFT)
#define CTX_MYTEE_EL3STATE_ALL	(CTX_MYTEE_EL3STATE_END >> DWORD_SHIFT)
#define CTX_MYTEE_SYSREGS_ALL	(CTX_MYTEE_EL3STATE_END >> DWORD_SHIFT)
/*
...
DEFINE_REG_STRUCT(mytee, CTX_MYTEE_ALL);
DEFINE_REG_STRUCT(mytee_el3_state, CTX_MYTEE_EL3STATE_ALL);
DEFINE_REG_STRUCT(mytee_el1_sys_regs, CTX_MYTEE_SYSREGS_ALL);
/*
...
typedef struct cpu_context {
	...
	mytee_t mytee_ctx;
	mytee_el3_state_t mytee_el3state_ctx;
	mytee_el1_sys_regs_t mytee_sysregs_ctx;
} cpu_context_t;
...
#define get_mytee_ctx(h)	(&((cpu_context_t *) h)->mytee_ctx)
#define get_mytee_sysregs_ctx(h)	(&((cpu_context_t *) h)->mytee_sysregs_ctx)
#define get_mytee_gpregs_ctx(h)	(&((cpu_context_t *) h)->mytee_gpregs_ctx)
...
CASSERT(CTX_MYTEE_OFFSET == __builtin_offsetof(cpu_context_t, mytee_ctx), \
	assert_core_context_mytee_offset_mismatch);
CASSERT(CTX_MYTEE_SYSREGS_OFFSET == __builtin_offsetof(cpu_context_t, mytee_sysregs_ctx), \
	assert_core_context_mytee_sys_offset_mismatch);
CASSERT(CTX_MYTEE_EL3STATE_OFFSET == __builtin_offsetof(cpu_context_t, mytee_el3state_ctx), \
	assert_core_context_mytee_el3state_offset_mismatch);
/*
...
#undef CTX_MYTEE_ALL
#undef CTX_MYTEE_EL3STATE_ALL
#undef CTX_MYTEE_SYSREG_ALL
